...
3. [Chapter III](#chapter-iii) \
    3.1. [Part 1](#part-1-реализация-библиотеки-containersh)  
    3.2. [Part 2](#part-2-дополнительно-реализация-библиотеки-containersplush)  
    3.3. [Part 3](#part-3-дополнительно-реализация-модифицированных-методов-emplace)


## Chapter I

![containers](misc/images/containers.png)
...
Необходимо реализовать классы библиотеки `containers.h` (спецификации указаны в соответствующих разделах материалов, см. пункт **"Основные контейнеры"**). \
...
Необходимо реализовать функции библиотеки `containersplus.h` (спецификации указаны в соответствующих разделах материалов, см. пункт **"Дополнительные контейнеры"**). \
